...
translations = {
    ...
    "বাংলা": {  # Bengali
        "instruction": "স্ক্যান করার জন্য ছবি এখানে ড্র্যাগ করুন",
    ...
    "తెలుగు": {  # Telugu
        "instruction": "స్కానింగ్ కోసం చిత్రాన్ని ఇక్కడ డ్రాప్ చేయండి",
        "ready": "చిత్రం స్వీకరించబడింది",
        "toggle_light": "☕ డార్క్ రోస్ట్",
        "toggle_dark": "🥛 లైట్ లాట్",
        "watermark": "ప్రాణ్‌పిక్సెల్",
        "buy": "ఇప్పుడే కొనండి",
        "best_deal": "ఉత్తమ ధర"
    },
    "मराठी": {  # Marathi
        "instruction": "स्कॅन करण्यासाठी इमेज येथे ड्रॅग आणि ड्रॉप करा",
        "ready": "इमेज प्राप्त झाली",
        "toggle_light": "☕ डार्क रोस्ट",
        "toggle_dark": "🥛 लाइट लॅट्टे",
        "watermark": "प्राणपिक्सेल",
        "buy": "आता खरेदी करा",
    ...
    "தமிழ்": {  # Tamil
        ...
        "toggle_dark": "🥛 லைட் லட்டு",
        "watermark": "பிரான்பிக்சல்",
        "buy": "இப்பொழுதே வாங்கவும்",
